...
const welcome_p = "The 'Aliens America' NFT Project is a decentralized, open-source project that aims to demonstrate how to develope and launch your own NFT Collection. Follow step by step on the <a href='https://youtube.com/codestackr'  target='_blank' rel='noopener noreferrer'>codeSTACKr</a> YouTube channel.'";
const h1_presale_coming_soon = "Alien America NFT Drop Coming Soon!!";
const h1_presale_mint = "Pre-Sale Minting Open!!";
const h1_public_mint = "Mind Control That Alien Grunt Guardian!";
